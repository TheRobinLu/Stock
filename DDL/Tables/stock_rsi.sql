...
CREATE TABLE `rsi` (
  ...
  `dRSI1` double DEFAULT NULL,
  `dRSI2` double DEFAULT NULL,
  `dRSI3` double DEFAULT NULL,
  `dRSI4` double DEFAULT NULL,
  `dRSI5` double DEFAULT NULL,
  `daysInRange` int DEFAULT NULL,
  PRIMARY KEY (`code`,`dayId`,`days`),
  KEY `ind_rsi` (`code`,`days`,`RSI`),
  KEY `ind_rsi_rangedays` (`code`,`days`,`daysInRange`),
  KEY `ind_date` (`code`,`days`,`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rsi`
--